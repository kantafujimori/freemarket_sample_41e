class InitSchema < ActiveRecord::Migration[5.2]
  def up
    ...
    create_table "delivery_dates", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
      t.string "delivery_date", null: false
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
    end
    create_table "delivery_fee_owners", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    create_table "shipping_methods", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
      t.string "shipping_method", null: false
      t.datetime "created_at", null: false
      t.datetime "updated_at", null: false
      t.integer "delivery_fee_owner_id"
    end
    create_table "sizes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
